...
export function generateElectricienEliteProContactTemplate(data: TemplateData, navigation: NavigationItem[]): string {
  return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contact ${data.companyName} - Électricien ${data.city} | Devis Gratuit</title>
    <meta name="description" content="Contactez ${data.companyName}, électricien expert à ${data.city}. Devis gratuit, intervention rapide 24h/7j. Appelez le ${data.phone} ou demandez un devis en ligne.">
    <meta name="keywords" content="contact électricien ${data.city}, devis électricien, ${data.companyName}, urgence électrique">
    
    <!-- SEO Avancé -->
    <meta property="og:title" content="Contact ${data.companyName} - Électricien ${data.city}">
    <meta property="og:description" content="Contactez votre électricien expert à ${data.city}. Devis gratuit, intervention rapide.">
...
<body>
    ...
    <section class="contact-hero">
        <div class="container">
            <div class="contact-hero-content">
                ...
                <p>
                    Votre électricien expert à ${data.city}. Devis gratuit, intervention rapide, 
                    satisfaction garantie. Parlons de votre projet !
                </p>
                
                <div class="hero-stats">
                    <div class="stat-item">
                        <div class="stat-number">< 30min</div>
                        <div class="stat-label">Délai d'intervention</div>
                    </div>
                    <div class="stat-item">
        ...
        <div class="container">
            <div class="contact-grid">
                ...
                <div class="contact-info">
                    ...
                    <p>
                        Besoin d'un électricien professionnel à ${data.city} ? 
                        ${data.companyName} est à votre écoute pour tous vos projets électriques. 
                    ...
                    <div class="contact-methods">
                        <div class="contact-method" onclick="window.location.href='tel:${data.phone}'">
                            ...
                            <div class="contact-method-info">
                                ...
                                <p>Appel gratuit - Devis immédiat</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-method" onclick="window.open('https://wa.me/33${data.phone.replace(/[^0-9]/g, '').substring(1)}', '_blank')">
                            <div class="contact-method-icon">💬</div>
                            <div class="contact-method-info">
                                <h3>WhatsApp</h3>
                                <p>Chat direct</p>
                    ...
                    <div class="emergency-info">
                        <h3>🚨 Urgences 24h/7j</h3>
                        <p>Panne électrique, disjoncteur qui saute, problème de sécurité ? Nous intervenons immédiatement.</p>
                ...
                <div class="contact-form" id="contact-form">
                    <div class="form-header">
                        ...
                        <p>Décrivez votre projet, nous vous répondons sous 24h</p>
                    </div>
                    ...
                    <form id="contactForm">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select id="urgency" name="urgency">
                                    <option value="normal">Dans la semaine</option>
                                    <option value="quick">Dans les 2-3 jours</option>
                                    <option value="urgent">Urgence - Aujourd'hui</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="message" name="message" required placeholder="Décrivez votre besoin : type de travaux, surface, contraintes particulières, budget approximatif..."></textarea>
                        </div>
    ...
    <section class="service-areas">
        <div class="container">
            ...
            <p>
                ${data.companyName} intervient dans ${data.city} et dans toute la région. 
                Découvrez toutes les villes où nous proposons nos services d'électricité.
            </p>
    ...
    <script>
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            const subject = encodeURIComponent(\`\${urgencyPrefix}Demande de devis - \${data.firstName} \${data.lastName} - \${data.city}\`);
            const body = encodeURIComponent(
                \`Nouvelle demande de devis électricien\\n\\n\` +
                \`👤 CLIENT:\\n\` +
                ...
                \`---\\nDemande envoyée depuis le site web \${window.location.hostname}\`
            );

  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Vue d'ensemble de votre activité AWEMA 2</p>
      </div>
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Clients totaux</dt>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Formulaires envoyés</dt>
                  <dd className="text-lg font-medium text-gray-900">0</dd>
                </dl>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900">Gérer les templates</span>
                </div>
                <svg className="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900">Voir la production</span>
                </div>
                <svg className="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="p-6">
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Commencez par ajouter un client</p>
            </div>
          </div>
        </div>
      </div>
